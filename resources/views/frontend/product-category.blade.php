...
<section class="banner_main">
         ...
         <div class="container">
            ...
            <div class="product_main">
                  ...
                  <div class="project_box" style="">
                     <div class="dark_white_bg" > <a href="{{ url('product/'.$product->id)}}"><img  src="{{ url('upload/'.$product->photo) }}" alt="#"/></a></div>
                     <h3>{{ $product->name }}  ${{ $product->price }}</h3>
                     <p class="btn-holder"><a href="{{ url('add-to-cart/'.$product->id) }}" class="btn btn-warning btn-block text-center" role="button">Add to cart</a> </p>
                  </div>
                   @endforeach
               <div class="col-md-12">
                  <a class="read_more see_more" href="#">See More</a>
               </div>
            </div>
            </div>
         </div>
      ...
      <div class="fashion">
         <img src="{{ asset('frontend/images/fashion.jpg')}}" alt="#"/>
      </div>
